    ...
    <div class="l-constrained l-section--lg faux faux--primary">
        <div class="l-primary l-padding-td l-primary-wd">
            <?php foreach($review_list as $row) : ?>
                <div class="row">
                        <div class="pod">
                             <a class="box" href="<?php echo base_url('review/view/'.$row->id)?>" title="<?=$row->title?>">
                                 <div class="box__image-wrap medium-4 column">
                                     <img class="box__image" src="<?php echo base_url('/upload/reviews/'.$row->image)?>" alt="<?=$row->title?>" title="<?=$row->title?>">
                                 </div>
